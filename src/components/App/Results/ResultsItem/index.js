        ...
        <div className="ResultsItem-flip-card-inner">
          ...
          <div className="ResultsItem-flip-card-back">
            ...
            <aside className="ResultsItem-flip-card-back-info">
              ...
              <p className="ResultsItem-flip-card-back-info-lastAppearance">{lastAppearance === "NA" ? "Unknown" : Array.isArray(lastAppearance) ? lastAppearance[0] : lastAppearance}</p>
              <h3 className="ResultsItem-flip-card-back-info-title">Voiced by:</h3>
              <p className="ResultsItem-flip-card-back-info-voicedBy">{voicedBy === "NA" ? "Unknown" : Array.isArray(voicedBy) ? voicedBy[0] : voicedBy}</p>
            </aside>
